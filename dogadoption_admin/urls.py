...
urlpatterns = [
    ...
    path('users/<userid:id>/violations/add/', views.admin_user_add_violation, name='admin_user_add_violation'),
    path('users/<userid:id>/violations/history/', views.admin_user_violation_history, name='admin_user_violation_history'),
